...
export default class Project extends React.Component {
  ...
  static async getInitialProps({ query }) {
    const res = await fetch(
      `https://dev.atec.io/wp-json/wp/v2/project?slug=${query.slug}`,
    );
      ...
      <Layout title={this.props.project.title.rendered}>
        <Container className='single-item'>
            ...
            <Col xs='12' md='5' className='single-feature-img'>
              <img
                ...
                src={convertUrlToHttps(
                  this.props.project.research_image.guid,
                )}></img>
            </Col>
            <Col xs='12' md='7'>
              <div className='single-title'>
                ...
                <h2 className='display-3'>
                  {this.props.project.title.rendered}
                </h2>
                {/* </ReactFitText> */}
              </div>
            </Col>
              ...
              <div>
                <h5 className='display-5'>
                  {this.props.project.access_link && (
                    <a target='blank' href={this.props.project.access_link}>
                      Project Link
                    </a>
                  )}
                </h5>
          ...
          <Row className='mb-1 justify-content-center'>
            <Col xs='12' className='project-short-description text-center'>
          ...
          <Row className='mb-5 justify-content-center'>
            <Col
              ...
              dangerouslySetInnerHTML={this.renderContent()}></Col>
          </Row>
